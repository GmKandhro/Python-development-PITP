...
# 1. Aap supermarket gaye ho. Ek item ki price price = 120 hai.
# Agar price 100 se zyada ho to "Expensive" print karo, warna "Affordable".
...
# 2. Ek student ka percentage = 40 hai.
# Agar 85 ya zyada hai to "Excellent",
# agar 60–84 ke beech hai to "Good",
# warna "Needs Improvement".
...
# 3. Ek company internship me agar applicant ka cgpa = 3.2 hai
# aur 3.0 se kam hai to "Not Eligible", warna "Eligible".
